...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp11(string p0, string p1, string p2, string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaBehaviour.FDelegate))
			{
			    return new LuaBehaviour.FDelegate(__Gen_Delegate_Imp11);
			}
